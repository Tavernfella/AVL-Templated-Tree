 ...
 * Author: vince
 *
 * Created on May 24, 2019, 8:46 PM
 */
...
class AVLTree {
    ...
    private:
        ...
        void prntBFS(AVLTreeNode<T>* tree, int space) const;
...
template <class T>
void AVLTree<T>::prntBFS() {
    prntBFS(mRoot, 0);
}

template <class T>
void AVLTree<T>::prntBFS(AVLTreeNode<T>* tree, int space) const{
    if(tree == NULL)
        return;
    
    space += 10;
    //Print right child first
    prntBFS(tree->right, space);
    std::cout << std::endl;
...
AVLTreeNode<T>* AVLTree<T>::insert(AVLTreeNode<T>* &tree, T key)
{
    ...
    {
        cout << "Insert failed! This key is already in the tree. " << endl;
    }
